...
class Environment:
    def __init__(self, game):
        self.game = game
        self.L1_line1_array_source = np.array(
        ...
        self.L1_line2_array_source = np.array(
        ...
        self.L1_goals_array_source = np.array(
        ...
        self.L2_line1_array_source = np.array(
            [[307, 28], [428, 26], [555, 33], [661, 39], [733, 59], [768, 95], [773, 160], [770, 232], [766, 297],
             [725, 371], [686, 431], [646, 470], [601, 504], [539, 536], [495, 578], [485, 613], [502, 638], [564, 650],
             [622, 631], [699, 586], [752, 523], [791, 434], [806, 344], [805, 268], [797, 180], [806, 82], [861, 24],
             [981, 15], [
                 1101, 15], [1292, 17], [1497, 51], [1572, 196], [1560, 375], [1436, 453], [1279, 453], [1200, 460],
             [1179, 495], [1188, 530], [1214, 551], [1315, 557], [1391, 566], [1532, 668], [1564, 790], [1548, 898],
             [1366, 987], [1067, 991], [738, 995], [383, 988], [146, 979], [77, 958], [13, 902], [6, 776], [12, 589],
             [14, 414], [22, 194], [62, 103], [145, 51], [307, 28]])
        self.L2_line2_array_source = np.array(
            [[199, 575], [195, 435], [234, 300], [326, 233], [419, 240], [479, 292], [471, 393], [427, 470], [303, 608],
             [254, 703], [263, 767], [329, 820], [439, 837], [555, 834], [667, 824], [810, 773], [907, 695], [975, 578],
             [987, 522], [991, 418], [978, 323], [968, 229], [1026, 175], [1142, 171], [1302, 181], [
                 1386, 216], [1368, 253], [1326, 277], [1199, 310], [1115, 324], [1036, 376], [1015, 454], [1018, 551],
             [1023, 661], [1095, 723], [1301, 746], [1401, 747], [1418, 765], [1404, 785], [1356, 815], [1270, 816],
             [1057, 802], [898, 811], [658, 860], [577, 866], [437, 866], [348, 863], [262, 831], [239, 792],
             [209, 668], [199, 575]])
        self.L2_goals_array_source = np.array(
            [[751., 78., 459., 275.], [726., 370., 476., 326.], [578., 516., 457., 418.], [493., 588., 370., 533.],
             [498., 632., 311., 805.], [586., 643., 599., 830.], [707., 577., 826., 761.], [787., 443., 989., 484.],
             [805., 268., 972., 269.], [849., 36., 1009., 190.], [1073., 15., 1106., 172.], [1389., 33., 1327., 192.],
             [1570., 226., 1378., 231.], [1496., 416., 1356., 260.], [1302., 453., 1259., 295.], [
                 1193., 471., 1080., 347.], [1184., 514., 1017., 525.], [1232., 552., 1174., 732.],
             [1432., 596., 1378., 747.], [1559., 824., 1412., 774.], [1400., 971., 1343., 815.],
             [1132., 990., 1112., 806.], [861., 993., 837., 823.], [627., 993., 618., 863.], [420., 989., 438., 866.],
             [220., 982., 272., 834.], [11., 867., 228., 747.], [11., 608., 203., 614.], [16., 353., 204., 403.],
             [21., 225., 229., 316.], [222., 40., 307., 247.], [441., 27., 391., 238.]])
        self.load_level()
...
class RocketMeister10(gym.Env):
    ...
    def render(self, mode=None):
        ...
        def init_renderer(self):
            self.ROCKET_IMG = [pygame.transform.scale2x(pygame.image.load(os.path.join('imgs', 'rocket_no_power.png'))),
                               pygame.transform.scale2x(pygame.image.load(os.path.join(
                                   'imgs', 'rocket_power.png'))), pygame.transform.scale2x(
                    pygame.image.load(os.path.join('imgs', 'rocket_power_front.png'))),
                               pygame.transform.scale2x(pygame.image.load(os.path.join('imgs', 'rocket_black.png')))]

...
POWERUP_RESPAWN_EVENT = pygame.USEREVENT + 1  # Event for when the powerup respawns
...
class Powerup(pygame.sprite.Sprite):
    def __init__(self, id):
        ...
        pygame.time.set_timer(POWERUP_RESPAWN_EVENT, self.POWERUP_RESPAWN_TIME)
    ...
    def update(self, player_rect, powerups):
        ...
        for event in pygame.event.get(
                POWERUP_RESPAWN_EVENT
        ):
            if event.type == POWERUP_RESPAWN_EVENT:
